...
export const mockProjects: Project[] = [
  {
    ...
    images: ["/cafe-project.jpg"],
    description:
      "مقهى عصري مجهز بالكامل في موقع استراتيجي ممتاز بوسط المدينة. يضم أحدث معدات تحضير القهوة والمشروبات الساخنة والباردة. المكان مؤثث بالكامل ويحتوي على ديكور عصري جذاب.",
    status: "approved",
  ...
  },
  {
    ...
    description:
      "مطعم شعبي مجهز بمطبخ احترافي كامل وصالة طعام واسعة. يقع في منطقة حيوية ويحتوي على جميع المعدات اللازمة لبدء العمل فوراً.",
    status: "approved",
  ...
  },
  {
    ...
    images: ["/retail-project.jpg"],
    description:
      "محل ملابس نسائية في موقع ممتاز بمنطقة تسوق مزدحمة. يحتوي على ديكور أنيق ومعدات عرض احترافية. المحل جاهز للعمل ويحتوي على مخزون من الملابس العصرية.",
    status: "approved",
  ...
  },
  {
    ...
    images: ["/cafe-project.jpg"],
    description:
      "صالون حلاقة رجالي مجهز بأحدث المعدات في منطقة سكنية مكتظة. يحتوي على 4 كراسي حلاقة وجميع الأدوات المطلوبة للعمل.",
    status: "approved",
  ...
  },
  {
    ...
    images: ["/restaurant-project.jpg"],
    description:
      "مخبز آلي حديث مجهز بأحدث المعدات لإنتاج الخبز والمعجنات. يحتوي على فرن آلي حديث وجميع معدات الإنتاج المطلوبة.",
    status: "approved",
  ...
  },
  {
    ...
    images: ["/retail-project.jpg"],
    description:
      "صيدلية مجهزة بالكامل مع ترخيص ساري المفعول. تحتوي على جميع المعدات المطلوبة وأرفف عرض احترافية.",
    status: "approved",
