...
export function HeroSection() {
  return (
    <section className="relative hero-gradient min-h-screen text-white py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center fade-in">
          ...
          <p className="text-base md:text-lg mb-10 text-white/80 max-w-2xl mx-auto leading-relaxed">
            وفر وقتك واحصل على مشروع مربح وجاهز للعمل فوراً. نوفر لك أفضل الفرص
            الاستثمارية المدروسة والمضمونة
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <Link to="/upload">أضف مشروعك</Link>
            </Button>
          </div>
        </div>
      </div>
